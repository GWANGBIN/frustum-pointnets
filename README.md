...
It doesn't really seem that the operation of the library is strongly affected by the version of its dependent libraries. This codes worked fine under the condition of `python 2.7.12`, `tensorflow-gpu 1.11.0`, `python-opencv 2.4.9.1`, `PySide 1.2.4`, `mayavi 4.6.2`, `gnuplot 5.0 patch level 3` (all latest stable versions in November 4th, 2018).
